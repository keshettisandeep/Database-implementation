...
&nbsp;&nbsp; Value1&nbsp;
        <asp:TextBox ID="TextBox1" 
            runat="server" ontextchanged="TextBox1_TextChanged" Width="183px"></asp:TextBox>
&nbsp;&nbsp; Value 2&nbsp;&nbsp;<asp:TextBox ID="TextBox2" runat="server" ontextchanged="TextBox2_TextChanged" 
            style="margin-left: 0px" Width="157px"></asp:TextBox>
    </p>
        <br />
        <br /><br /><br />
